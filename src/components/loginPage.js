      ...
      <div class="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-4">
        <div class="max-w-md w-full">
          <div class="text-center mb-8">
            ...
            <p class="text-gray-600 text-lg">Definir nova palavra-passe</p>
          </div>
          ...
          <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="flex items-center justify-center gap-1.5 mb-5">
              ...
              <p class="text-xs text-gray-500">Introduza a sua nova palavra-passe</p>
            </div>
      ...
      <div class="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-4">
        <div class="max-w-md w-full">
          <div class="text-center mb-8">
            ...
            <p class="text-gray-600 text-lg">Recuperar palavra-passe</p>
          </div>
          ...
          <div class="bg-white rounded-2xl shadow-xl p-8">
            <div class="flex items-center justify-center gap-1.5 mb-5">
              ...
              <p class="text-xs text-gray-500">Enviaremos um link para o seu email</p>
            </div>
      ...
      <div class="max-w-md w-full">
        <div class="text-center mb-8">
          ...
          <p class="text-gray-600 text-lg">
            A tua jornada para uma vida livre de vaping comeca aqui
          </p>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div class="flex items-center justify-center gap-1.5 mb-5">
            ...
            <p class="text-xs text-gray-500">A sua password esta segura e so voce tem acesso</p>
          </div>
